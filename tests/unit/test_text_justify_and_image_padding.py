                    ...
                    'elements': [
                        {
                            ...
                            'z': 10,
                            'figure': {
                                'src': 'examples/assets/test-images/kittens/kitten-1.jpg',
                                'caption': None,
                                'fit': 'contain',
                            },
                            'padding_mm': pad,
                        },
                        {
                            'id': 's',
                            'type': 'svg',
                            'area': {'x': 4, 'y': 1, 'w': 3, 'h': 2},
                            'z': 10,
                            'svg': {
                                'src': 'examples/assets/test-svgs/test-plan-p11.svg',
                                'scale': 1.0,
                            },
                            'padding_mm': pad,
                        },
                        {
                            'id': 'p',
                            'type': 'pdf',
                            'area': {'x': 7, 'y': 1, 'w': 3, 'h': 2},
                            'z': 10,
                            'pdf': {'src': 'test-pdfs/test-plan.pdf', 'pages': [1], 'scale': 1.0},
                            'padding_mm': pad,
                        },
                    ],
                }
